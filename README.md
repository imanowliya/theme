...
.theme-dark {
  ...
  .colorMuted-HdFt4q.size12-3cLvbJ:first-child:before {
    content: "MinimalCord v1.0.2 by Gibbu";
    display: block;
  }
  ...
  #app-mount .membersWrap-2h-GB4 .scroller-2FKFPG::-webkit-scrollbar {
    display: none;
  }
  #app-mount .membersWrap-2h-GB4 .member-3-YXUe {
    padding-right: 0;
    max-width: 100%;
    border-radius: 0;
  }
  #app-mount .membersWrap-2h-GB4 .member-3-YXUe .layout-2DM8Md {
    border-radius: 5px 0 0 5px;
  }
  #app-mount .membersWrap-2h-GB4 .member-3-YXUe:hover .layout-2DM8Md {
    background: var(--channel-hovered-bg);
  }
  #app-mount .membersWrap-2h-GB4 .member-3-YXUe.selected-aXhQR6 .layout-2DM8Md {
    background: var(--channel-selected-bg);
    box-shadow: inset -4px 0 0 rgba(var(--accent), 1);
  }
  ...
  #app-mount .searchResultsWrap-2DKFzt .scroller-2FKFPG {
    overflow-x: hidden;
    padding-right: 8px;
  }
  #app-mount .searchResultsWrap-2DKFzt .sibling-3tUBeh {
    opacity: 0.3;
  }
  #app-mount .searchResultsWrap-2DKFzt .searchHeader-1l-wpR {
    z-index: 105;
    position: relative;
    background: var(--search-result-header);
    box-shadow: var(--box-shadow);
  }
  #app-mount .searchResultsWrap-2DKFzt .searchHeader-1l-wpR .tab-2Ixsn0,
  #app-mount .searchResultsWrap-2DKFzt .searchHeader-1l-wpR .totalResults-gxvzgw {
    opacity: 1;
    color: var(--text-3);
  }
  #app-mount .searchResultsWrap-2DKFzt .searchHeader-1l-wpR .tab-2Ixsn0.selected-16te-P,
  #app-mount .searchResultsWrap-2DKFzt .searchHeader-1l-wpR .totalResults-gxvzgw.selected-16te-P {
    color: var(--text-1);
  }
  #app-mount .searchResultsWrap-2DKFzt .channelName-1QajIf {
    background: transparent;
  }
  #app-mount .searchResultsWrap-2DKFzt .searchResult-3pzFAB {
    overflow: visible;
  }
  #app-mount .searchResultsWrap-2DKFzt .searchResult-3pzFAB:after, #app-mount .searchResultsWrap-2DKFzt .searchResult-3pzFAB:before {
    content: none;
  }
  #app-mount .searchResultsWrap-2DKFzt .searchResultMessage-2VxO12.hit-NLlWXA {
    border: none;
    box-shadow: var(--box-shadow), 0 0 20px 15px var(--background-1);
    background: var(--message-box);
  }
  #app-mount .searchResultsWrap-2DKFzt .searchResultMessage-2VxO12.hit-NLlWXA .embedFull-2tM8-- {
    background: var(--background-2);
  }
  #app-mount .searchResultsWrap-2DKFzt .searchResultMessage-2VxO12.hit-NLlWXA .embedFull-2tM8-- .embedTitle-3OXDkz {
    color: rgba(var(--accent), 1);
  }
  #app-mount .searchResultsWrap-2DKFzt .searchResultMessage-2VxO12:not(.hit-NLlWXA) .embedFull-2tM8-- {
    background: var(--message-box);
  }
  #app-mount .searchResultsWrap-2DKFzt .searchResultMessage-2VxO12:not(.hit-NLlWXA) .embedFull-2tM8-- .embedTitle-3OXDkz {
    color: rgba(var(--accent), 1);
  }
  #app-mount .searchResultsWrap-2DKFzt .searchResult-3pzFAB.expanded-v2Szsz {
    background: var(--background-2);
    border: none;
  }
  #app-mount .searchResultsWrap-2DKFzt .searchResult-3pzFAB.expanded-v2Szsz .searchResultMessage-2VxO12.hit-NLlWXA {
    box-shadow: var(--box-shadow);
  }
  ...
  #app-mount .userPopout-3XzG_A .bodyInner-245q0L {
    background: var(--user-popout-body);
    padding: 10px;
  }
  #app-mount .userPopout-3XzG_A .bodyInner-245q0L::-webkit-scrollbar {
    display: none;
  }
  ...
  #app-mount .userPopout-3XzG_A .footer-1fjuF6 .quickMessage-1yeL4E {
    background: var(--user-popout-message);
    border: none;
    margin: 0 10px 10px;
    box-sizing: border-box;
  ...
  #app-mount .userPopout-3XzG_A .footer-1fjuF6 .quickMessage-1yeL4E::placeholder {
  ...
  #app-mount .contextMenu-HLZMGh .itemBase-tz5SeC.selected-BYpGTS {
    background: transparent;
  }
  #app-mount .contextMenu-HLZMGh .itemBase-tz5SeC:hover {
  ...
  #app-mount .messagesPopoutWrap-1MQ1bW .messagesPopout-24nkyi {
    background: transparent;
  }
  #app-mount .messagesPopoutWrap-1MQ1bW .messagesPopout-24nkyi .messageGroupWrapper-o-Zw7G {
    border: none;
    box-shadow: var(--box-shadow);
    background-color: var(--dropdown-item-hover);
  }
  #app-mount .messagesPopoutWrap-1MQ1bW .messagesPopout-24nkyi .actionButtons-1sUUug {
    box-shadow: none;
    background-color: transparent;
  }
  #app-mount .messagesPopoutWrap-1MQ1bW .messagesPopout-24nkyi:after {
    content: none;
  }
